...
const Navbar = () => {
  ...
  const pathName = useLocation().pathname; // pathname from the location object
  ...
  return (
    <header className="sticky top-0 z-50 flex items-center shadow-sm h-headerHeight text-textColor bg-headerColor">
      <nav className="flex items-center justify-between w-full h-full px-4 sm:px-10">
        <Link to="/">
          {" "}
          ...
          {token ? (
            <>
              ...
              <button
                ...
                className="w-24 px-4 py-2 font-semibold text-center rounded-sm cursor-pointer bg-customRed hover:text-slate-300"
              >
                LogOut
              </button>
            </>
            ...
            <Link to="/signup">
              <li className="w-24 px-4 py-2 font-semibold text-center rounded-sm cursor-pointer bg-btnColor hover:text-slate-300">
                SignUp
              </li>
            </Link>
          )}
        ...
        <span
          ...
          className="block shadow-md cursor-pointer lg:hidden text-textColor hover:text-slate-400"
        >
          {headerToggle ? (
