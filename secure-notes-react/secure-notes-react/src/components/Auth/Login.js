...
const Login = () => {
  ...
  const { setToken, token ,isAdmin } = useMyContext();
    ...
    <div className="min-h-[calc(100vh-74px)] flex justify-center items-center">
      {step === 1 ? (
        <React.Fragment>
          ...
          >
            <div>
              <h1 className="text-2xl font-bold text-center font-montserrat">
                Login Here
              </h1>
              ...
              <div className="flex items-center justify-between gap-1 py-5 ">
                <Link
                  ...
                  className="flex items-center justify-center flex-1 gap-1 p-2 transition-all duration-300 border rounded-md shadow-sm shadow-slate-200 hover:bg-slate-300"
                >
                  <span>
                    <FcGoogle className="text-2xl" />
                  </span>
                  <span className="text-xs font-semibold sm:text-customText">
                    Login with Google
                  </span>
                </Link>
                <Link
            ...
            <Buttons
              disabled={loading}
              onClickhandler={() => {}}
              className="w-full py-2 my-3 font-semibold text-white transition-colors duration-100 rounded-sm bg-customRed hover:text-slate-400"
              type="text"
            >
        ...
        <React.Fragment>
          ...
          >
            <div>
              ...
              <Divider className="pb-4 font-semibold"></Divider>
            </div>
